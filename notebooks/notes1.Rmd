...
## Shapes in other directions

Let's make sure we can grow on the X and Y axis also. A shape in the X direction looks like: 

```{r echo=TRUE, message=FALSE}
source("../shapevol1/R/sgene.R")
source("../shapevol1/R/genetostl.R")

gene3 <- sgene("DirectionX",          1,status = T,start=0.0,stop=0.7,dom=1)
gene4 <- sgene("Cross section","Square",status = T,start=0.0,stop=1.5,dom=1)
gene5 <- sgene("Length",            0.75,status = T,start=0.0,stop=1.5,dom=1)
gene6 <- sgene("Diameter",          0.2,status = T,start=0.0,stop=1.5,dom=1)
group1 <- rbind(gene3,gene4,gene5,gene6)

genetostlfile("~/Desktop/stl/shape1X.stl",group1,runlim=1)
...
gene3 <- sgene("DirectionY",          1,status = T,start=0.0,stop=0.7,dom=1)
gene4 <- sgene("Cross section","Square",status = T,start=0.0,stop=1.5,dom=1)
gene5 <- sgene("Length",            0.75,status = T,start=0.0,stop=1.5,dom=1)
gene6 <- sgene("Diameter",          0.2,status = T,start=0.0,stop=1.5,dom=1)
group1 <- rbind(gene3,gene4,gene5,gene6)

genetostlfile("~/Desktop/stl/shape1Y.stl",group1,runlim=1)
